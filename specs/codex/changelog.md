...
最終更新: 2026-09-09（安定版は引き続き **0.153.4**（2026-09-04）で新しい安定版なし。公式 changelog 本文にも追記なし。GitHub リリースタグは 0.154.0-alpha.6（2026-09-07）/ alpha.7（2026-09-08）まで進んでいる。0.153.3 / 0.153.4 のホットフィックスで **GPT-6-Astra がモデルピッカーに露出し、明示設定がない場合のバンドル既定モデルになった**点は据え置き）
