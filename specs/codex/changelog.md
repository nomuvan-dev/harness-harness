...
最終更新: 2026-09-06（安定版 **0.153.4** まで。0.153.3 / 0.153.4 のホットフィックスで **GPT-6-Astra がモデルピッカーに露出し、明示設定がない場合のバンドル既定モデルになった**。0.153.1 時点の「既定は変わらない」という位置づけは 0.153.4 で覆っている。0.154.0 は alpha.3 が出た段階）
