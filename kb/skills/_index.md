...
| サイト | 種別 | 役割 |
|--------|------|------|
| [claude.com/plugins](https://claude.com/plugins) | Anthropic公式 | プラグイン/スキルディレクトリ（Frontend Design 1.13M installs が首位。Superpowers が 100万 installs 突破で 2 位に浮上。Anthropic 検証バッジ継続） |
| [anthropics/skills](https://github.com/anthropics/skills) | Anthropic公式 | 公式スキル実装例（167K+ stars、17 スキル。2026-07-24 に claude-api スキルが Opus 5 対応、以降新規 push なし） |
...
| [skills.sh](https://skills.sh/) | コミュニティ | スキルディレクトリ兼リーダーボード（find-skills が 2.9M installs でトップ。mattpocock 系が 6 本に top10 占有拡大、handoff が新規 top10 入り、ai-video-generation は圏外へ。agent-browser / vercel-react-best-practices は top10 継続） |
