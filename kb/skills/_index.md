...
| サイト | 種別 | 役割 |
|--------|------|------|
| [claude.com/plugins](https://claude.com/plugins) | Anthropic公式 | プラグイン/スキルディレクトリ（Frontend Design 1.11M installs が首位。言語別 LSP プラグイン群が台頭、Anthropic 検証バッジ導入） |
| [anthropics/skills](https://github.com/anthropics/skills) | Anthropic公式 | 公式スキル実装例（164K+ stars、17 スキル。2026-07-24 に claude-api スキルが Opus 5 対応） |
...
| [skills.sh](https://skills.sh/) | コミュニティ | スキルディレクトリ兼リーダーボード（find-skills が 2.7M installs でトップ。mattpocock 系 4 本が top10 継続、microsoft-foundry (azure-skills) が新規 top10 入り） |
